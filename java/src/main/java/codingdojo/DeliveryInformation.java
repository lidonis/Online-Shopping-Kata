...
/**
 * This class contains the information about how the customer would like to have the contents of
 * their shopping cart delivered to them.
 */
public class DeliveryInformation implements ModelObject {
  ...
  boolean isInDeliveryRange(Store storeToSwitchTo,
      LocationService locationService) {
    return getDeliveryAddress() != null && locationService
